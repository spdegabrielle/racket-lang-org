...
(define saturday (gregor:date 2026 10 4))
(define sunday (gregor:date 2026 10 5))
...
(column
 ...
 (section
  ...
  @paragraph{Registration link will be here when registration opens. In the meantime updates will be posted on the @a[#:href "https://racket-discourse.group"]{Racket Discourse}.
             If you cannot attend in-person, there will be an option to help support the livestream for remote participants.}
 )
...
Gathering with drinks and snacks.
 ...
 (section
   ...
   @paragraph{
              The (sixteenth RacketCon) is organised by a team of volunteers: Bogdan Popa organzied the program,
              Stephen Phjilips provided local arrangements, and
